...
/// Insights: rule-based observations about the current budget — where money
/// concentrates, ratios vs Swiss guidelines, and gentle tips. No judgement,
/// no advice claims; just clear, calm pointers.
struct InsightsView: View {
    ...
    var body: some View {
        ...
        .navigationSubtitle(loc(.insightsSubtitle))
        .toolbar {
            ToolbarItem(placement: .primaryAction) { MonthSelector() }
        }
    }
